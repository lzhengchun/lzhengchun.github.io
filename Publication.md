...
- [What does Inter-Cluster Job Submission and Execution Behavior Reveal to Us?](). <br>
Tirthak Patel, Devesh Tiwari, Raj Kettimuthu, William Allcock, Paul Rich and **Zhengchun Liu**. <br>
2022 IEEE International Conference on Cluster Computing.

- [SciStream: Architecture and Toolkit for Data Streaming between Federated Science Instruments](https://doi.org/10.1145/3502181.3531475). <br>
Joaquin Chung, Wojciech Zacherek, AJ Wisniewski, **Zhengchun Liu**, Tekin Bicer, Rajkumar Kettimuthu and Ian Foster. <br>
...
- [Braid-DB: Toward AI-Driven Science with Machine Learning Provenance]( https://doi.org/10.1007/978-3-030-96498-6_14). <br>
Justin Wozniak, **Zhengchun Liu**, Rafael Vescovi, Ryan Chard, Bogdan Nicolae, Ian Foster. <br>
...
The 3rd Workshop on Extreme-Scale Experiment-in-the-Loop Computing @ SC'21, [***Best paper awarded***](file/xloop21-bset-paper.png), [Preprint](https://arxiv.org/abs/2105.13967), [Highlight](https://www.anl.gov/dsl/article/argonne-researchers-receive-best-paper-award-at-sc21-xloop-workshop).

- [3D Autoencoders For Feature Extraction In X-ray Tomography](). <br>
Aniket Tekawade, **Zhengchun Liu**, Peter Kenesei, Tekin Bicer, Francesco De Carlo, Rajkumar Kettimuthu, Ian Foster.<br> 
2021 IEEE International Conference on Image Processing.

- [Fast and accurate learned multiresolution dynamical downscaling for precipitation](https://doi.org/10.5194/gmd-14-6355-2021). <br>
Jiali Wang, **Zhengchun Liu**, Ian Foster, Won Chang, Rajkumar Kettimuthu, Rao Kotamarthi.<br>
Journal of Geoscientific Model Development, 14, 6355–6372, 2021. [[PDF](http://arxiv.org/abs/2101.06813)],[[Code](https://github.com/lzhengchun/DSGAN)]
...
SC'20 HPC Systems Professionals Workshop [HPCSYSPROS](http://sighpc-syspros.org/workshops/2020/). [[PDF](file/HPCSYSPROS20-RLewis.pdf)]. 
...
SC'20 workshop on Artificial Intelligence and Machine Learning for Scientific Applications. [[PDF](https://arxiv.org/abs/2009.13589)].
...
*Journal of Machine Learning: Science and Technology, IOPscience, Vol 2, No. 4* [[PDF](https://doi.org/10.1088/2632-2153/ac1d35)]. 
...
*ISC High Performance 2020* (__ISC'20__). [[poster](file/isc20-poster.pdf)]. 

- Cyberinfrastructure and System Software for Online Analysis of Large-Scale Data: Challenges and Design Choices. [Handbook on Big Data and Machine Learning in the Physical Sciences](https://www.worldscientific.com/worldscibooks/10.1142/11389). Volume 2: Advanced Analysis Solutions for Leading Experimental Techniques. <br>
Rajkumar Kettimuthu, **Zhengchun Liu,** Tekin Bicer, Ian Foster. 
...
*IEEE/ACM 1st Annual Workshop on Large-scale Experiment-in-the-Loop Computing* (**XLOOP, SC'19**). [[PDF](https://arxiv.org/abs/1911.05878)]. 
...
*IEEE/ACM 3rd Workshop on Deep Learning on Supercomputers*(**DLS, SC'19**). [[PDF](https://arxiv.org/abs/1910.04081)], [[Video](https://youtu.be/PcHsOK4qwlk)], [[Slides](file/DLS-2019-ZLiu.pdf)].
...
*Journal of the Optical Society of America A*, Vol. 37, No. 3, February 2020. [[PDF](https://arxiv.org/abs/1902.07582)], [[Code](https://github.com/lzhengchun/TomoGAN)]
...
- [Estimation of RTT and Loss Rate of Wide-Area Connections Using MPI Measurements]().<br>
Nageswara Rao, Neena Imam, Rajkumar Kettimuthu, __Zhengchun Liu__ and Ian Foster.<br>
*2019 IEEE/ACM Innovating the Network for Data-Intensive Science (INDIS)*

- [Machine Learning Methods for Connection RTT and Loss Rate Estimation Using MPI Measurements Under Random Losses](). <br>
Nageswara Rao, Neena Imam, Rajkumar Kettimuthu, __Zhengchun Liu__ and Ian Foster. <br>
*International Conference on Machine Learning for Networking* (**MLN'19**), [***Best paper award***](file/BestPaperAwardMLN2019.jpg). 

- [Measurements and Analytics of Wide-Area File Transfers over Dedicated Connections](https://doi.org/10.1145/3288599.3288641). <br>
Nageswara Rao, Qiang Liu, Satyabrata Sen, __Zhengchun Liu__, Rajkumar Kettimuthu, and Ian Foster. <br>
...
- [End-to-End Online Performance Data Capture and Analysis for Scientific Workflows](https://doi.org/10.1016/j.future.2020.11.024).<br>  
...
[[PDF](http://www.mcs.anl.gov/~zcliu/file/ai-science18.pdf). *The 1st AI-Science workshop* (**AI-Science, HPDC'18**).
...
- [Learning Concave-Convex Profiles of Data Transport Over Dedicated Connections](). <br>
Nageswara Rao, Satyabrata Sen, __Zhengchun Liu__, Rajkumar Kettimuthu and Ian Foster. <br>
...
- [Model of Collaborative UAV Swarm Toward Coordination and Control Mechanisms Study](https://doi.org/10.1016/j.procs.2015.05.274).<br>
Xueping Zhu, __Zhengchun Liu__ and Jun Yang.<br>
*2015 International Conference on Computational Science* (**ICCS'15**). [[Slides](file/uav-agent.pdf). 
...
*International Journal of Integrated Care*, 16(6):A145 2016. [[Slides](file/5.8_Zhengchun_Liu_139.pdf)

- [Correlation between Piezoresponse Nonlinearity and Hysteresis in Ferroelectric Crystals at Nanoscale.](https://doi.org/10.1063/1.4947533). <br>
Linglong Li, Yaodong Yang, __Zhengchun Liu__, Stephen Jesse, Sergei V. Kalinin and Rama K. Vasudevan.  <br>
*Applied Physics Letters*, Vol.108, January 2017, Pages 300–309. 

- Modeling and Simulation for Healthcare Operations Management using High Performance Computing and Agent-Based Model. [thesis overview] <br>
__Zhengchun Liu__ and Emilio Luque. <br>
*Journal of Computer Science & Technology*, Vol. 17, 2017. [[PDF](file/Zhengchun-Liu-Thesis-Overview.pdf)] 

- High Performance Computing Based Simulation for Healthcare Decision Support. <br>
__Zhengchun Liu__. <br>
*The Second International BSC Doctoral Symposium*, Barcelona, Spain. May 5-7, 2015. [[Slides](file/zliu-bsc-2015.pdf), [Abstract](file/Extended-Research-Abstract.pdf)].

- Study of Emergency Department by Using High Performance Computing. <br>
__Zhengchun Liu__, Eduardo Cabrera, Dolores Rexachs and Emilio Luque. <br>
*XXV Jornadas de Paralelismo Valladolid (national)*. September 2014 [[PDF](file/Jornadas_sarteco_2014.pdf)]. Jornadas sarteco 2014

- A Simulator of Emergency Departments for Decision Support and QoS Improving [[poster](file/girona_ict_poster.pdf)]. <br>
__Zhengchun Liu__, Emilio Luque, Dolores Rexachs, Francisco Epelde, Eduardo Cabrera, Manel Taboada González. <br>
V CONFERENCE: R+D+I Research and Development in ICT and Health. Girona, Spain, June 2014.

- Research on Co-simulation Method in ADAMS and MATLAB for Missile Seeker’s Stabilization Platform Design. <br>
Xueping Zhu, __Zhengchun Liu__, and Jun Yang. <br>
AsiaSim 2013. Singapore, November 6-8, 2013.

- Design and Implementation of a Missile Seeker Virtual Test-Bed Based on High Level Architecture. <br>
__Zhengchun Liu__ and Jun Yang. <br>
Proceedings of the 2012 the 3d International Conference on Mechanic Automation and Control Engineering. July 27-29, 2012.
